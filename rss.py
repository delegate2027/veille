...
def get_entries(feed_url):
    """Récupère les entrées d'un flux RSS. Retourne [] en cas d'erreur."""
    try:
        parsed = feedparser.parse(feed_url)

        # feedparser ne lève pas d'exception mais met bozo=True si le flux est invalide
...
# Chemin corrigé : tiret au lieu d'espace
WORKFLOW_FILE = ".github/workflows/update-rss.yml"
INDEX_FILE = "index.html"

def get_meetings_entries():
    """Lit les entrées du fichier meetings.xml local. Retourne [] si absent."""
...
def main():
    ...
    # Ajout des entrées de meetings.xml
